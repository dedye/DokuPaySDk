...
public class NetworkModule {
    public static final int CONNECT_TIMEOUT_IN_MS = 60000;

    @Provides
    @Singleton
    public OkHttpClient okHttpClient(HttpLoggingInterceptor loggingInterceptor, Cache cache,@ApplicationContext Context context) {
        try {
